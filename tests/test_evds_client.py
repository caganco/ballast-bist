"""
Tests for ballast.data.evds_client - cleanup + TÜFE freshness audit.
...
from ballast.data.evds_client import _parse_evds_date, is_series_fresh
...
class TestIsSeriesFresh:
    """is_series_fresh(): stale-detect unit tests."""
